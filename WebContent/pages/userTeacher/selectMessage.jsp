        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <table id="example2" class="table table-bordered table-hover">
            	...
            	<tr>
			      <form action="<%=request.getContextPath()%>/utx/getutxbynum" method="post" class="sidebar-form">
                ...
                <!-- 学生号搜索 -->
			      ...
			      <form action="<%=request.getContextPath()%>/utx/getutxbynum" method="post" class="sidebar-form">
			        <div class="input-group">
			          <td>
			          	 <input type="text" name="stuNum" class="form-control" placeholder="学生号搜索...">
			          </td>
			     	  <td>
			          	  <span class="input-group-btn">
			                <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
            	...
            	<tr>     
            	  <form action="<%=request.getContextPath()%>/utx/getallutx" method="post" class="sidebar-form">
            		<td>
            			<input type="submit" class="btn btn-block btn-info" value="显示全部选修信息">
            		</td>
            	</form>
            	</tr>
            </table>
              ...
              <table id="example2" class="table table-bordered table-hover">
				...
				<c:forEach items="${utbs}" var="utb">
					<tr>
	                  ...
	                  <th>${utb.stuName}</th>
	                  <th>${utb.stuNum}</th>
	                  <form action="<%=request.getContextPath()%>/utx/updateutx" method="post">
