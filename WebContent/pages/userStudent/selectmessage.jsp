        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <!-- 课程名搜索 -->
            	<tr>
			      <form action="<%=request.getContextPath()%>/usx/getusxbynum" method="post" class="sidebar-form">
            	...
            	<tr>     
            	  <form action="<%=request.getContextPath()%>/usx/getallusx" method="post" class="sidebar-form">
            		<td>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
				...
				<tbody>
				<c:forEach items="${usxs}" var="usx">
				<tr>
                  <th>${usx.courseNum}</th>
                  <th>${usx.courseName}</th>
                  <th>${usx.teacherName}</th>
                  <th>${usx.score}</th>
                  <th>${usx.courseCredit}</th>
                  <th>${usx.term}</th>
                </tr>
				</c:forEach>
