  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <!--必修课信息  -->
        <li class="treeview">
          <a href="<%=request.getContextPath()%>/userTeacher/userTeacher.jsp">
            ...
            <ul class="treeview-menu">
          	<li><a href="<%=request.getContextPath()%>/utb/getallutb"><i class="fa fa-circle-o"></i>必修课信息</a></li>            
          </ul>
        </li>
        ...
        <!--选修课信息  -->
        <li class="treeview">
          <a href="<%=request.getContextPath()%>/userTeacher/selectMessage.jsp">
          ...
          <ul class="treeview-menu">
               <li><a href="<%=request.getContextPath()%>/utx/getallutx"><i class="fa fa-circle-o"></i>选修课信息</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             <li><a href="#"><i class="fa fa-circle-o"></i>授课中心</a></li>
          </ul>
        </li>
